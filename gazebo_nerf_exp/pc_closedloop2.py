...
from pc_simple_models import get_all_models, pre_process_data2, strip_data
...
if __name__ == "__main__":
    ...
    # pr = [0.5, 0.5, 0.5, 0.5, 0.5]
    # pr = [0.3, 0.3, 0.3, 0.3, 0.3]
    ...
    # data_file_path = os.path.join(script_dir, './data_pc/data_09-03-09-52.pickle')
